...
############################################# Change file paths and parameters here
# top = number of top CENTRIMO-scored motifs to retrieve
top = 5
# inLocList = A list containing all the folders with the meme-chip results
inLocList = glob("/work/eg474423/eg474423_Projects/trunk/Dream/exp/meme_chip/meme/*/")
# outLoc = The ouput location of the resulting top PFMs
outLoc = "/Users/egg/Projects/Costa_Dream/exp/motifs/pfm/"
#############################################
