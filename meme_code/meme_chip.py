...
# inLoc = Input location of the challenge gunzipped ChIP-seq peaks
inLoc = "/hpcwork/izkf/projects/dream_tfbs/local/ChIPseq/peaks/conservative/"
# genomeFastaFile = Input location of the genome in fasta format
genomeFastaFile = "/hpcwork/izkf/projects/TfbsPrediction/Data/HG19/hg19.fa"
# motifDB = Database of motifs obtained in http://meme-suite.org/meme-software/Databases/motifs/motif_databases.12.15.tgz
motifDB = "/work/eg474423/eg474423_Projects/trunk/Dream/exp/meme_chip/JASPAR_CORE_2016_vertebrates.meme"
# outLoc = Output location of the analysis
...
for factor in factorList:
  ...
  print "### "+factor+" ------------------------------------------\n"
  sys.stdout.flush()
  clusterCommand = "./pipeline.sh "+inLoc+" "+outLoc+" "+factor+" "+genomeFastaFile+" "+motifDB
